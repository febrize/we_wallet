    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 76.0, middle: 0.3523),
            Pin(size: 117.3, middle: 0.7308),
            child: Stack(
              children: <Widget>[
                SizedBox(
                  width: 76.0,
