    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: -57.0, end: 50.0),
            Pin(size: 123.0, middle: 0.4421),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
...
// background:
                        ...
                        Positioned.fill(
                          child: Padding(
                            padding:
                                EdgeInsets.fromLTRB(19.0, 13.0, 19.0, 14.0),
                            child: Column(
...
// background:
                        ...
                        Positioned.fill(
                          child: Padding(
                            padding:
                                EdgeInsets.fromLTRB(19.0, 13.0, 19.0, 11.0),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.stretch,
                              children: <Widget>[
                                SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    ...
                    Pin(size: 29.0, start: 0.0),
                    child:
                        // Adobe XD layer: 'Icon material-histo…' (shape)
                        SvgPicture.string(
                      _svg_h1kkkg,
                      allowDrawingOutsideViewBox: true,
                      fit: BoxFit.fill,
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  child: Pinned.fromPins(
                                    ...
                                    child:
                                        // Adobe XD layer: 'Icon weather-lightn…' (shape)
                                        SvgPicture.string(
                                      _svg_w8h,
                                      allowDrawingOutsideViewBox: true,
                                      fit: BoxFit.fill,
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  child: Pinned.fromPins(
                                    ...
                                    Pin(start: 22.0, end: -22.0),
                                    child:
                                        // Adobe XD layer: 'Icon material-movie' (shape)
                                        SvgPicture.string(
                                      _svg_cawr9,
                                      allowDrawingOutsideViewBox: true,
                                      fit: BoxFit.fill,
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  child: Pinned.fromPins(
                                    ...
                                    child:
                                        // Adobe XD layer: 'Icon ionic-ios-airp…' (shape)
                                        SvgPicture.string(
                                      _svg_udkz73,
                                      allowDrawingOutsideViewBox: true,
                                      fit: BoxFit.fill,
